...
def rescale_thetas(theta0, theta1, datas):
    ...
    scaled_theta0 = theta0 * (ymax - ymin) - theta1 * (xmax - xmin) * xmin + ymin
    print("we calculate theta0 =", scaled_theta0, "theta1 =", scaled_theta1)
...
def main():
    ...
    stheta1, stheta0 = get_ab_math(cars)
    theta0, theta1 = gradient_descent(normalized_cars, 0, 0, 0.01)
    print("we got theta0 =", theta0, "theta1 =", theta1)
    print("we want theta0 =", stheta0, "theta1 =", stheta1)
    rescale_thetas(theta0, theta1, cars)
    # theta0, theta1 = rescale_thetas(theta0, theta1, cars)
    # get_rmse(cars, theta0, theta1)
    # plot_datas(normalized_cars, theta0, theta1, "Calculated linear regression")
    plot_datas(cars, stheta0, stheta1, "Calculated linear regression")
    # plot_datas(normalized_cars, theta0, theta1, "Calculated linear regression")
    # get_rmse(cars, theta0, theta1)
